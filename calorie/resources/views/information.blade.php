...
<ul>
  ...
  <li>カレンダーでは過去の記録を確認することができます。確認したい日付をクリックすることで、その日登録したデータを確認することができます。(注)体重などのユーザーデータが入力されていない場合には
    性別は男性、体重60kg、身長170cmで計算されたものが表示されます。下に表示される体重の値は0kgと表示されるようになります。
  </li>
